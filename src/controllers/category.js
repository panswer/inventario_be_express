...
const getCategoryById = async (req, res) => {
  ...
  try {
    ...
    loggerService.error('categoryService@getCategoryById', {
...
const createCategory = async (req, res) => {
  ...
  if (existingCategory) {
    loggerService.warn('categoryService@getCategoryByName', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
  ...
  try {
    ...
    loggerService.error('categoryService@createCategory', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
...
const updateCategoryById = async (req, res) => {
  ...
  if (!category) {
    loggerService.error('categoryService@getCategoryByName', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
  ...
  try {
    ...
    loggerService.error('categoryService@updateCategoryById', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
...
const toggleCategory = async (req, res) => {
  ...
  try {
    ...
    loggerService.error('categoryService@toggleCategory', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
