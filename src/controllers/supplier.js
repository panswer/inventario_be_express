...
const getSupplierById = async (req, res) => {
  ...
  try {
    ...
    loggerService.error('supplierService@getSupplierById', {
...
const createSupplier = async (req, res) => {
  ...
  if (existingSupplier) {
    loggerService.warn('supplierService@getSupplierByRif', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
  ...
  try {
    ...
    loggerService.error('supplierService@createSupplier', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
...
const updateSupplierById = async (req, res) => {
  ...
  try {
    ...
    loggerService.error('supplierService@updateSupplierById', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
...
const toggleSupplier = async (req, res) => {
  ...
  try {
    ...
    loggerService.error('supplierService@toggleSupplier', {
      requestId: req.requestId,
      userIp: req.userIp,
      body: req.body,
      reason: error?.message ?? 'Unknown error',
